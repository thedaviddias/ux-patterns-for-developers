---
name: time-input
description: "Build user-friendly time input fields with validation and accessibility features. Use when you need to enter time in a structured format."
user-invocable: true
triggers:
  - time
  - input
metadata:
  ...
  sourcePath: apps/web/content/patterns/forms/time-input.mdx
---
