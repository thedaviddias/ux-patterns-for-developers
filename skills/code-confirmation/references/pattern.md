...
- [input-otp](https://github.com/guilhermerodz/input-otp) - Headless OTP input for React
- [react-otp-input](https://github.com/devfolioco/react-otp-input) - OTP input component for React
- [vue-otp-input](https://github.com/bachdgvn/vue-otp-input) - OTP input for Vue.js
- [ng-otp-input](https://github.com/code-farmz/ng-otp-input) - OTP input for Angular

### Design Systems

- [Mantine PinInput](https://mantine.dev/core/pin-input/) - Pin/OTP input component
- [Chakra UI PinInput](https://chakra-ui.com/docs/components/pin-input) - Accessible pin input component
- [shadcn/ui InputOTP](https://ui.shadcn.com/docs/components/input-otp) - OTP input with copy-paste support

### Articles & Guides

- [One-Time Code from SMS](https://web.dev/web-otp/) - WebOTP API for SMS autofill
- [Designing OTP Input Fields](https://uxdesign.cc/designing-otp-input-fields-ba36ec54cc5e) - UX best practices for code entry
- [SMS OTP Best Practices](https://www.twilio.com/blog/2fa-sms-design-best-practices) - Twilio's guide to 2FA UX
- [WCAG Input Accessibility](https://www.w3.org/WAI/tutorials/forms/grouping/) - Grouping form elements accessibly

### Tools & Utilities

- [WebOTP API](https://developer.mozilla.org/en-US/docs/Web/API/WebOTP_API) - Browser API for SMS one-time codes
- [TOTP Libraries](https://github.com/nicowillis/totp.js) - Time-based OTP generation
