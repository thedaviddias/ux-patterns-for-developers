---
name: ai-chat
description: "Learn how to implement AI chat interfaces. Use when you need to conversational AI chat interfaces."
user-invocable: true
triggers:
  - chat
  - interface
metadata:
  ...
  sourcePath: apps/web/content/patterns/ai-intelligence/ai-chat.mdx
---
