...
- Support keyboard navigation between segments with `Arrow` keys.
...
- Don't skip focus management for auto-advance — screen reader users need predictable focus behavior.
