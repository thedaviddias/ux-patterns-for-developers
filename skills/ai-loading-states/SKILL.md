...
description: "Learn how to implement AI-specific loading states. Use when you need to loading states for AI operations."
user-invocable: true
triggers:
  - loading
  - states
metadata:
  ...
  sourcePath: apps/web/content/patterns/ai-intelligence/ai-loading-states.mdx
---
