...
- [Downshift](https://www.downshift-js.com/) - Accessible multi-select primitives for React
- [React Select](https://react-select.com/) - Feature-rich multi-select with async support
- [Headless UI Combobox](https://headlessui.com/react/combobox) - Accessible combobox from Tailwind team
- [Choices.js](https://choices-js.github.io/Choices/) - Lightweight multi-select without dependencies

### Design Systems

- [Radix UI Select](https://www.radix-ui.com/primitives/docs/components/select) - Accessible select primitive
- [Mantine MultiSelect](https://mantine.dev/core/multi-select/) - Full-featured multi-select component
- [Chakra UI MultiSelect](https://chakra-ui.com/docs/components/select) - Multi-select for Chakra
- [Carbon Design Multi-Select](https://carbondesignsystem.com/components/multi-select/usage) - IBM multi-select guidelines

### Articles & Guides

- [ARIA Listbox Pattern](https://www.w3.org/WAI/ARIA/apg/patterns/listbox/) - W3C accessibility pattern for listboxes
- [ARIA Combobox Pattern](https://www.w3.org/WAI/ARIA/apg/patterns/combobox/) - W3C accessible combobox
- [Accessible Multi-Select](https://adrianroselli.com/2022/05/under-engineered-multi-selects.html) - Adrian Roselli on multi-select accessibility
- [Multi-select UX Research](https://baymard.com/blog/multi-select-listbox) - Baymard Institute usability study

### Tools & Utilities

- [Accessibility Checker](https://wave.webaim.org/) - Check component accessibility
- [ARIA Authoring Practices](https://www.w3.org/WAI/ARIA/apg/) - W3C ARIA patterns reference
