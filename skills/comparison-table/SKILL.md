...
description: "Learn how to implement comparison tables. Use when you need to compare features and options side-by-side."
user-invocable: true
triggers:
  - comparison
  - table
metadata:
  ...
  sourcePath: apps/web/content/patterns/data-display/comparison-table.mdx
---
