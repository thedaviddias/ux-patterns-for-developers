---
name: slider
description: "Learn how to implement accessible range slider inputs in your web applications. Use when you need to select values from a range."
user-invocable: true
triggers:
  - slider
metadata:
  ...
  sourcePath: apps/web/content/patterns/forms/slider.mdx
---
...
Pattern page: https://uxpatterns.dev/patterns/forms/slider
