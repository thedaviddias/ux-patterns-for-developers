...
.reset-btn:hover:not(:disabled) { background: #1d4ed8; }
.reset-btn:disabled { opacity: 0.6; cursor: not-allowed; }
.reset-btn:focus-visible { outline: 2px solid #2563eb; outline-offset: 2px; }
...
- **Timing:** Real-time on each keystroke in the confirm field
...
#### Node.js
- [Nodemailer](https://nodemailer.com/) – Email sending for password reset flows
- [crypto.randomBytes](https://nodejs.org/api/crypto.html#cryptorandombytessize-callback) – Secure token generation

#### React Components
- [React Hook Form](https://react-hook-form.com/) – Form handling with validation
- [Clerk Forgot Password](https://clerk.com/docs/custom-flows/forgot-password) – Pre-built password reset flow

### Articles

- [Password Reset Best Practices](https://cheatsheetseries.owasp.org/cheatsheets/Forgot_Password_Cheat_Sheet.html) by OWASP
- [Reset Password UX](https://www.nngroup.com/articles/password-creation/) by Nielsen Norman Group
