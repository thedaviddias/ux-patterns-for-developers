...
description: "Learn how to implement effective form validation in your web applications. Use when you need to validate and provide feedback."
user-invocable: true
triggers:
  - form
  - validation
metadata:
  ...
  sourcePath: apps/web/content/patterns/forms/form-validation.mdx
---
