...
**Source:** apps/web/content/patterns/navigation/pagination.mdx
...
- [`rc-pagination`](https://www.npmjs.com/package/rc-pagination) - Pagination control primitive for server-driven page navigation.
- [`react-paginate`](https://www.npmjs.com/package/react-paginate) - Pagination UI component for client- or server-driven page switching.
