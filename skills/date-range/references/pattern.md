...
- Mark range-start, range-end, and in-range day cells with descriptive aria attributes.
...
- Don't leave screen reader users without feedback about which selection step they're on.
...
- [React DayPicker](https://react-day-picker.js.org/) - Supports range mode with customization
- [Flatpickr](https://flatpickr.js.org/) - Date range mode built-in
- [Litepicker](https://litepicker.com/) - Lightweight date range picker
- [Air Datepicker](https://air-datepicker.com/) - Feature-rich date picker with range support

### Design Systems

- [Airbnb Date Picker](https://github.com/airbnb/react-dates) - The original hotel-style range picker
- [shadcn/ui Date Range Picker](https://ui.shadcn.com/docs/components/date-range-picker) - Styled range picker component
- [Radix UI Calendar](https://www.radix-ui.com/primitives/docs/components/calendar) - Headless calendar with range support

### Articles & Guides

- [Date Range Picker UX](https://uxdesign.cc/date-range-picker-design-pattern-f1b649e43a48) - UX design patterns for range selection
- [ARIA Date Picker Pattern](https://www.w3.org/WAI/ARIA/apg/patterns/dialog-modal/examples/datepicker-dialog/) - W3C accessibility guide
- [Hotel Booking UX Research](https://baymard.com/blog/date-range-pickers) - Baymard Institute date range research

### Tools & Utilities

- [date-fns](https://date-fns.org/) - Date utility library for range calculations
- [Day.js](https://day.js.org/) - Lightweight date library with range plugin
