...
- The root panel fixed to the left (or right) edge of the [viewport](/glossary/viewport)
...
- **Trigger:** Route change ([page navigation](/glossary/pagination))
...
- **Mobile overlay content** — hidden sidebar content is still in the [DOM](/glossary/dom) and crawlable
