---
name: model-selector
description: "Learn how to implement model selectors. Use when you need to aI model selection interface."
user-invocable: true
triggers:
  - model
  - selector
metadata:
  ...
  sourcePath: apps/web/content/patterns/ai-intelligence/model-selector.mdx
---
