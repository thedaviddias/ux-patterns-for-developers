...
> Learn how to implement social login. Discover best practices for OAuth flows, provider integration, and account linking.

**URL:** https://uxpatterns.dev/patterns/authentication/social-login
**Source:** apps/web/content/patterns/authentication/social-login.mdx
