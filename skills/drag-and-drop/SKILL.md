---
name: drag-and-drop
description: "Build intuitive drag and drop functionality with accessibility and touch support. Use when you need to allow users to reorder items intuitively."
user-invocable: true
triggers:
  - drag
  - and
