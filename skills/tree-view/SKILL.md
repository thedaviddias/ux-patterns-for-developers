---
name: tree-view
description: "Learn how to implement tree views for hierarchical data. Use when you need to display hierarchical data structures."
user-invocable: true
triggers:
  - tree
  - view
metadata:
  ...
  sourcePath: apps/web/content/patterns/data-display/tree-view.mdx
---
...
Pattern page: https://uxpatterns.dev/patterns/data-display/tree-view
