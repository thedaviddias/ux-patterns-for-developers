...
> Learn how to implement user profile interfaces. Discover best practices for displaying user information, avatars, and account settings.

**URL:** https://uxpatterns.dev/patterns/authentication/user-profile
**Source:** apps/web/content/patterns/authentication/user-profile.mdx
...
function UserProfile({ user, isOwnProfile, onFollow, onEdit }) {
      ...
      <div className="profile-header">
        ...
        <div className="profile-identity">
          ...
          <div className="profile-meta">
            ...
            {user.website && <a href={user.website}>{new URL(user.website).hostname}</a>}
            {user.joinedDate && <span>Joined {user.joinedDate}</span>}
          </div>
        </div>
        ...
        <div className="profile-actions">
          {isOwnProfile ? (
            ...
            <>
              <button type="button" className="follow-btn" onClick={onFollow}>
            ...
            {user.activity.map((item) => (
              <li key={item.id} className="activity-item">
                ...
                <div>
                  ...
                  <time dateTime={item.date}>{item.relativeTime}</time>
                </div>
              </li>
            ))}
          </ul>
...
.follow-btn:hover { background: #1d4ed8; }
...
.activity-item p { margin: 0; font-size: 0.9375rem; }
.activity-item time { font-size: 0.8125rem; color: #9ca3af; }
.activity-item a { color: #2563eb; text-decoration: none; }
...
@media (prefers-reduced-motion: reduce) {
  .edit-btn, .follow-btn, .message-btn { transition: none; }
}
```
...
**The Problem:**
Users upload a large photo and it gets auto-cropped awkwardly, cutting off faces or important parts.
...
#### React Components
- [react-avatar-editor](https://github.com/mosch/react-avatar-editor) – Avatar upload with crop and rotate
- [react-dropzone](https://react-dropzone.js.org/) – File upload component
- [shadcn/ui Avatar](https://ui.shadcn.com/docs/components/avatar) – Avatar component with fallback

### Articles

- [Designing User Profiles](https://www.nngroup.com/articles/user-profile-page-design/) by Nielsen Norman Group
- [Profile Design Patterns](https://www.smashingmagazine.com/2024/01/designing-better-user-profiles/) by Smashing Magazine
- [Avatar Design Best Practices](https://uxdesign.cc/avatar-design-best-practices-6c4e3c5d4b97) by UX Collective

### Design Systems

- [GitHub Profile](https://github.com/settings/profile) – Developer profile reference
- [Material Design Cards](https://m3.material.io/components/cards/overview) – Card-based profile layout
