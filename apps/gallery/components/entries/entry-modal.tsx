...
export function EntryModal({
	...
	return (
		<Dialog open={isOpen} onOpenChange={onClose}>
			<DialogContent className="p-0 overflow-hidden bg-white dark:bg-gray-900">
				...
				<div className="relative w-full h-full rounded-2xl shadow-2xl overflow-hidden flex flex-col">
					...
					{/* Header */}
					<header className="p-6 border-b border-fd-border bg-white dark:bg-gray-900">
						<div className="flex items-start justify-between">
							...
							<div className="flex-1 min-w-0">
								...
								<h1 className="text-xl font-bold text-fd-foreground mb-2">
									{entry.title}
								</h1>
								<a
							...
							<div className="flex items-center gap-3 ml-4">
								<button
									type="button"
									className="px-3 py-1.5 bg-fd-primary text-fd-primary-foreground rounded-lg text-sm font-medium hover:bg-fd-primary/90 transition-colors"
								>
									Share
								</button>
								<button
					...
					{/* Image */}
					<div className="flex-1 relative bg-gray-100 min-h-0 p-8">
						<div className="w-full h-full relative flex items-center justify-center">
							{entry.media.type === "image" ? (
								...
								<div className="flex items-center justify-center h-96 w-full text-gray-500 bg-gray-100 rounded-lg">
					...
					{/* Footer */}
					<footer className="p-6 border-t border-fd-border bg-white dark:bg-gray-900">
									...
									{entry.tags.map((tag) => (
										<button
											...
											onClick={() => {
												...
												onClose();
												// Navigate to clean pattern URL
												window.location.href = `/explore/web/all/${encodeURIComponent(tag)}`;
											}}
