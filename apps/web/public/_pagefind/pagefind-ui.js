(() => {
  ...
  var Rn = typeof window < 'u' ? window : typeof globalThis < 'u' ? globalThis : global,
    de = class {
      constructor(e) {
  ...
  typeof HTMLElement === 'function' &&
    (Ds = class extends HTMLElement {
      ...
      attributeChangedCallback(n, _e, t) {
        this[n] = t;
      }
  ...
  var q = class {
    ...
    $set(e) {
      this.$$set && !En(e) && ((this.$$.skip_bound = !0), this.$$set(e), (this.$$.skip_bound = !1));
    }
  };
  function I(n) {
  ...
  function lt(n, e = {}) {
    ...
    if (l > 1 && l < 9) {
      ...
      for (
        ...
        let a = l + 2,
          o = 0;
        for (; r.charCodeAt(a) === 45 && Z(r.charCodeAt(a + 1)) && Z(r.charCodeAt(a + 2)); ) {
          const f = a + 1;
    ...
    return t;
    function i(a, o, f) {
      return e.warning?.(f, o, a), e.forgiving ? t : vn();
    }
  }
  function vn() {
    return {
    ...
    return {
      c() {
        i?.c(),
          ...
          g(s, 'class', 'pagefind-ui__result-title pagefind-ui__loading svelte-j9e30'),
  ...
  function Hn(_n) {
    ...
    return {
      c() {
        (e = C('div')),
          g(e, 'class', 'pagefind-ui__result-thumb pagefind-ui__loading svelte-j9e30');
      },
      m(t, s) {
        S(t, e, s);
      },
  ...
  function Fn(n) {
    ...
    return {
      c() {
        (e = C('div')), t?.c(), g(e, 'class', 'pagefind-ui__result-thumb svelte-j9e30');
      },
      m(s, r) {
        S(s, e, r), t?.m(e, null);
      },
    ...
    return {
      ...
      p(r, l) {
        l & 2 && !ie(e.src, (t = r[1].meta?.image)) && g(e, 'src', t),
          l & 2 && s !== (s = r[1].meta?.image_alt || r[1].meta?.title) && g(e, 'alt', s);
      },
      d(r) {
        r && k(e);
      },
    ...
    return {
      c() {
        i?.c(),
          ...
          g(s, 'class', 'pagefind-ui__result-title pagefind-ui__loading svelte-4xnkmf'),
      ...
      p(a, _o) {
        a[0] ? i || ((i = Pn(a)), i.c(), i.m(e.parentNode, e)) : i && (i.d(1), (i = null));
      },
      d(a) {
        i?.d(a), a && k(e), a && k(t);
      },
    ...
    return {
      ...
      p(d, T) {
        if (
          ...
          d[4] ? (p ? p.p(d, T) : ((p = Bn(d)), p.c(), p.m(t, f))) : p && (p.d(1), (p = null)),
          T & 8)
        ) {
          h = d[3];
          let R;
      ...
      d(d) {
        m?.d(d), d && k(e), d && k(t), p?.d(), Q(_, d), c?.d();
      },
    };
  }
  function Pn(_n) {
    ...
    return {
      c() {
        (e = C('div')),
          g(e, 'class', 'pagefind-ui__result-thumb pagefind-ui__loading svelte-4xnkmf');
      },
      m(t, s) {
        S(t, e, s);
      },
  ...
  function Ln(n) {
    ...
    return {
      c() {
        (e = C('div')), t?.c(), g(e, 'class', 'pagefind-ui__result-thumb svelte-4xnkmf');
      },
      m(s, r) {
        S(s, e, r), t?.m(e, null);
      },
  ...
  function Vn(n) {
    ...
    return {
      ...
      m(u, m) {
        S(u, e, m), b(e, t), b(t, s), b(s, l), b(e, a), b(e, o), (o.innerHTML = f);
      },
      p(u, m) {
      ...
      p = async (_) => {
        t(1, (a = await _.data())),
          ...
          Array.isArray(a.sub_results) &&
            ...
            u ? t(3, (f = m(a.sub_results.slice(1), 3))) : t(3, (f = m([...a.sub_results], 3))));
      },
  ...
  function Xn(n) {
    ...
    return {
      ...
      m(o, f) {
        ...
        for (let u = 0; u < a.length; u += 1) a[u]?.m(e, null);
      },
      p(o, f) {
        if ((f & 112 && s !== (s = `${o[4]('filters_label', o[5], o[6])}`) && N(r, s), f & 143)) {
    ...
    return {
      ...
      m(h, _) {
        S(h, e, _),
          ...
          (i.innerHTML = a),
          b(l, o);
        for (let c = 0; c < p.length; c += 1) p[c]?.m(l, null);
        b(e, f);
      },
      p(h, _) {
        if (
          (_ & 2 && s !== (s = `${h[10].replace(/^(\w)/, es)}`) && (t.innerHTML = s),
        ...
        _ & 138 && u !== (u = h[7] || h[3].map(ts).includes(h[10].toLowerCase())) && (e.open = u);
      },
      d(h) {
        h && k(e), Q(p, h);
      },
      ...
      (n.$$.update = () => {
        if (n.$$.dirty & 258) {
          if (s && !u) {
            ...
            h.length === 1 && Object.entries(h[0][1])?.length <= 6 && t(7, (m = !0));
          }
        }
      }),
      [f, s, r, l, i, a, o, m, u, p]
  ...
  function as(n) {
    ...
    return (
      ...
      {
        c() {
          (e = C('div')), s.c(), g(e, 'class', 'pagefind-ui__results-area svelte-e9gkc3');
        },
        m(o, f) {
  ...
  function ya(n) {
    let e,
      ...
      o;
    function f(c, _d) {
      return c[13].results.length === 0 ? wa : c[13].results.length === 1 ? va : Aa;
    }
    let u = f(n, [-1, -1]),
      m = u(n),
    ...
    return {
      ...
      m(c, d) {
        ...
        S(c, i, d), _?.m(c, d), S(c, a, d), (o = !0);
      },
      p(c, d) {
        u === (u = f(c, d)) && m ? m.p(c, d) : (m.d(1), (m = u(c)), m && (m.c(), m.m(e, null))),
          d[0] & 139292 &&
  ...
  function cs(n) {
    ...
    return {
      c() {
        (e = C('p')), (s = w(t)), g(e, 'class', 'pagefind-ui__message svelte-e9gkc3');
      },
      m(r, l) {
        S(r, e, l), b(e, s);
      },
      p(r, l) {
        l[0] & 589952 &&
          t !== (t = `${r[20]('searching', r[19], r[7]).replace(/\[SEARCH_TERM\]/, r[16])}`) &&
          N(s, t);
      },
      d(r) {
        r && k(e);
  ...
  function Na(n) {
    ...
    return {
      ...
      p(R, M) {
        (!h || (M[0] & 524416 && r !== (r = R[20]('placeholder', R[19], R[7])))) &&
          g(s, 'placeholder', r),
          (!h || M[0] & 256) && (s.autofocus = R[8]),
          M[0] & 512 && s.value !== R[9] && pt(s, R[9]),
          (!h || M[0] & 524416) && a !== (a = `${R[20]('clear_search', R[19], R[7])}`) && N(o, a),
          ...
          (!h || (M[0] & 524416 && p !== (p = R[20]('search_label', R[19], R[7])))) &&
            g(t, 'aria-label', p),
      ...
      d(R) {
        R && k(e), n[34](null), n[35](null), d?.d(), T?.d(), (_ = !1), G(c);
      },
    };
  }
  ...
  function ja(n, e, t) {
    ...
    for (let E = 0; E < r.length; E++) s[r[E]] = { language: r[E], ...ss[E].strings };
    let { base_path: l = '/pagefind/' } = e,
      ...
      ds = (E, F, j) => j[E] ?? F[E] ?? '';
    gt(() => {
      const E = document?.querySelector?.('html')?.getAttribute?.('lang') || 'en',
...
`)
      ...
      hs = async () => {
        H && ((dn = await H.filters()), (!ce || !Object.keys(ce).length) && t(18, (ce = dn)));
      },
      ms = (E) => {
        const F = {};
        return (
      ...
      bs = (E) => {
        E.key === 'Escape' && (t(9, (v = '')), O.blur()), E.key === 'Enter' && E.preventDefault();
      };
    function Ts() {
  ...
  try {
    document?.currentScript &&
      ...
      (un = new URL(document.currentScript.src).pathname.match(/^(.*\/)(?:pagefind-)?ui.js.*$/)[1]);
  } catch {
    un = '/pagefind/';
  }
  var it = class {
