...
related_patterns: ["/patterns/navigation/pagination", "/patterns/user-feedback/notification", "/patterns/forms/form-validation"]
status: published
---
...
- [Notifications](/patterns/user-feedback/notification) - Alert messages
- [Form Validation](/patterns/forms/form-validation) - Error/success feedback
