...
<GuidesBanner
  title="Table vs List View vs Card Grid?"
  description="Compare the main collection display patterns before you choose one"
...
<PatternComparison
  current="List View"
  title="Choose the right collection layout"
  description="List view is best when people scan down a single stream. Compare it with denser tables and more visual card layouts before you lock in the pattern."
  alternatives={[
  {
    "name": "Data Table",
    "path": "/patterns/data-display/table",
    "when": "users need to compare several attributes across many rows or rely on sorting and filtering",
    "pros": [
      "Higher data density",
      "Better side-by-side comparison",
      "Stronger fit for structured analysis"
    ],
    "cons": [
      "Weaker on mobile",
  ...
  },
  {
    ...
    "when": "visual browsing matters more than single-column scanning and each item should feel self-contained",
    "pros": [
      "Stronger visual hierarchy",
      "Better for thumbnails and media",
      "More expressive item presentation"
    ],
    "cons": [
      "Weaker direct comparison",
      "Usually shows less information per screen"
    ]
  }
]}
/>
