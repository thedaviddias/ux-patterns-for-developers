...
<BuildEffort
  level="low"
  description="Primarily markup, state classes, and accessible labeling for display key metrics and statistics."
/>
...
<PatternComparison
  alternatives={[
  {
    ...
    "when": "users need charts & graphs instead of statistics display as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
    "cons": [
      "Less specialized for statistics display",
  ...
  },
  {
    ...
    "when": "users need dashboard layout instead of statistics display as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
  ...
  },
  {
    ...
    "when": "users need comparison table instead of statistics display as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
...
<Playground patternType="data-display" pattern="statistics" example="basic" presentation="hidden-code" />
...
<FaqStructuredData
  items={[
  {
    "question": "When should I choose Statistics Display instead of Charts & Graphs?",
    "answer": "Choose statistics display when the job depends on surface a small set of key metrics with enough context that users can judge direction, magnitude, and urgency quickly. If the team only needs a lighter interaction with fewer states, Charts & Graphs will usually be easier to ship and maintain."
  },
  {
    "question": "What is the biggest implementation risk with Statistics Display?",
  ...
  {
    "question": "How do I know whether statistics display is working well?",
