...
<PatternComparison
  ...
  description="Card grid is strongest when visuals do real decision-making work. Compare it with list and table layouts before defaulting to cards for everything."
  alternatives={[
  {
    "name": "List View",
    "path": "/patterns/data-display/list-view",
    "when": "users mainly scan a simple vertical stream and only a few attributes matter per item",
    "pros": [
      "Faster linear scanning",
      "Better mobile readability",
      "Lower visual noise"
    ],
    "cons": [
      "Less visual richness",
      "Weaker fit for media-heavy browsing"
    ]
  },
  {
    "name": "Data Table",
    "path": "/patterns/data-display/table",
    "when": "users must compare structured fields across many items and rely on sorting or filtering",
    "pros": [
      "Stronger comparison",
    ...
    "cons": [
      "Less visual appeal",
      "Poorer fit for browse-first experiences"
    ]
  },
  {
    "name": "Product Card",
    "path": "/patterns/e-commerce/product-card",
    "when": "the card itself needs domain-specific commerce details like pricing, ratings, stock, and purchase actions",
    "pros": [
      "Tailored for shopping flows",
      "Encodes ecommerce-specific metadata",
      "Supports stronger purchase intent"
    ],
    "cons": [
      "Too specialized for general libraries",
      "Heavier than a generic card grid"
    ]
  }
]}
/>
