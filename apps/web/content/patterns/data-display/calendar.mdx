...
<BuildEffort
  level="high"
  description="Requires coordinated state, async data, and strong accessibility coverage across the full calendar view experience."
/>
...
<PatternComparison
  alternatives={[
  {
    ...
    "when": "users need timeline instead of calendar view as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
    "cons": [
      "Less specialized for calendar view",
  ...
  },
  {
    ...
    "when": "users need list view instead of calendar view as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
  ...
  },
  {
    ...
    "when": "users need filter panel instead of calendar view as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
...
<Playground patternType="data-display" pattern="calendar" example="basic" presentation="hidden-code" />
...
<FaqStructuredData
  items={[
  {
    "question": "When should I choose Calendar View instead of Timeline?",
    "answer": "Choose calendar view when the job depends on present time-based information in a grid that helps people compare days, weeks, or months at a glance. If the team only needs a lighter interaction with fewer states, Timeline will usually be easier to ship and maintain."
  },
  {
    "question": "What is the biggest implementation risk with Calendar View?",
  ...
  {
    "question": "How do I know whether calendar view is working well?",
