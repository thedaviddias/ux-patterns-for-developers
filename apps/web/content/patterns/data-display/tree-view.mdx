...
<BuildEffort
  level="high"
  description="Requires coordinated state, async data, and strong accessibility coverage across the full tree view experience."
/>
...
<PatternComparison
  alternatives={[
  {
    ...
    "when": "users need navigation menu instead of tree view as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
    "cons": [
      "Less specialized for tree view",
  ...
  },
  {
    ...
    "when": "users need list view instead of tree view as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
  ...
  },
  {
    ...
    "when": "users need data table instead of tree view as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
...
<Playground patternType="data-display" pattern="tree-view" example="basic" presentation="hidden-code" />
...
<FaqStructuredData
  items={[
  {
    "question": "When should I choose Tree View instead of Navigation Menu?",
    "answer": "Choose tree view when the job depends on display nested relationships while still letting users expand, select, and navigate efficiently. If the team only needs a lighter interaction with fewer states, Navigation Menu will usually be easier to ship and maintain."
  },
  {
    "question": "What is the biggest implementation risk with Tree View?",
  ...
  {
    "question": "How do I know whether tree view is working well?",
