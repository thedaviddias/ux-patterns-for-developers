...
<BuildEffort
  level="high"
  description="Requires coordinated state, async data, and strong accessibility coverage across the full charts & graphs experience."
/>
...
<PatternComparison
  alternatives={[
  {
    ...
    "when": "users need statistics display instead of charts & graphs as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
    "cons": [
      "Less specialized for charts & graphs",
  ...
  },
  {
    ...
    "when": "users need dashboard layout instead of charts & graphs as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
  ...
  },
  {
    ...
    "when": "users need data table instead of charts & graphs as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
...
<FaqStructuredData
  items={[
  {
    "question": "When should I choose Charts & Graphs instead of Statistics Display?",
    "answer": "Choose charts & graphs when the job depends on translate quantitative data into a visual shape that makes change, comparison, or distribution easier to see. If the team only needs a lighter interaction with fewer states, Statistics Display will usually be easier to ship and maintain."
  },
  {
    "question": "What is the biggest implementation risk with Charts & Graphs?",
  ...
  {
    "question": "How do I know whether charts & graphs is working well?",
