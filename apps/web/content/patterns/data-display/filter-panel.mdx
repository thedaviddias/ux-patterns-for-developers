...
<BuildEffort
  level="medium"
  description="Requires structured state, keyboard handling, and resilient feedback for filter and refine data displays."
/>
...
alternatives={[
  {
    ...
    "when": "users need search results instead of filter panel as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
    "cons": [
      "Less specialized for filter panel",
  ...
  },
  {
    ...
    "when": "users need pagination instead of filter panel as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
  ...
  },
  {
    ...
    "when": "users need list view instead of filter panel as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
...
<Playground patternType="data-display" pattern="filter-panel" example="basic" presentation="hidden-code" />
...
<FaqStructuredData
  items={[
  {
    "question": "When should I choose Filter Panel instead of Search Results?",
    "answer": "Choose filter panel when the job depends on help users narrow a large collection without losing track of the active constraints or available results. If the team only needs a lighter interaction with fewer states, Search Results will usually be easier to ship and maintain."
  },
  {
    "question": "What is the biggest implementation risk with Filter Panel?",
  ...
  {
    "question": "How do I know whether filter panel is working well?",
