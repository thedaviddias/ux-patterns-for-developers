...
<BuildEffort
  level="medium"
  description="Requires structured state, keyboard handling, and resilient feedback for display chronological events and activities."
/>
...
<PatternComparison
  ...
  {
    "name": "Calendar View",
    "path": "/patterns/data-display/calendar",
    "when": "users need calendar view instead of timeline as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
    "cons": [
      "Less specialized for timeline",
  ...
  },
  {
    ...
    "when": "users need activity feed instead of timeline as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
  ...
  },
  {
    ...
    "when": "users need list view instead of timeline as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
...
<Playground patternType="data-display" pattern="timeline" example="basic" presentation="hidden-code" />
...
<FaqStructuredData
  items={[
  {
    "question": "When should I choose Timeline instead of Calendar View?",
    "answer": "Choose timeline when the job depends on show events in chronological order so users can reconstruct a sequence, audit a process, or follow progress over time. If the team only needs a lighter interaction with fewer states, Calendar View will usually be easier to ship and maintain."
  },
  {
    "question": "What is the biggest implementation risk with Timeline?",
  ...
  {
    "question": "How do I know whether timeline is working well?",
  ...
  patterns={[
    {
      title: "Calendar View",
      path: "/patterns/data-display/calendar",
      description: "Display dates and events in calendar format",
    },
    {
      title: "Activity Feed",
      path: "/patterns/social/activity-feed",
