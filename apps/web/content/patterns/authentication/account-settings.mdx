...
<Playground patternType="authentication" pattern="account-settings" example="basic" presentation="hidden-code" />
...
import { Playground } from "@/components/playground";heckmark, then fades out after 3 seconds
