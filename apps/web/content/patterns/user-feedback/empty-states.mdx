...
<BuildEffort
  level="low"
  description="Primarily markup, state classes, and accessible labeling for guide users when no content is available."
/>
...
<PatternComparison
  alternatives={[
  {
    ...
    "when": "users need notification instead of empty states as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
    "cons": [
      "Less specialized for empty states",
  ...
  },
  {
    ...
    "when": "users need filter panel instead of empty states as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
  ...
  },
  {
    ...
    "when": "users need loading indicator instead of empty states as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
...
<Playground patternType="user-feedback" pattern="empty-states" example="basic" presentation="hidden-code" />
...
<FaqStructuredData
  items={[
  {
    "question": "When should I choose Empty States instead of Notification?",
    "answer": "Choose empty states when the job depends on turn a blank or zero-result view into a helpful next-step moment instead of a dead end. If the team only needs a lighter interaction with fewer states, Notification will usually be easier to ship and maintain."
  },
  {
    "question": "What is the biggest implementation risk with Empty States?",
  ...
  {
    "question": "How do I know whether empty states is working well?",
