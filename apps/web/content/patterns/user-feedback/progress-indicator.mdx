...
<BuildEffort
  level="low"
  description="Primarily markup, state classes, and accessible labeling for show completion status of an operation."
/>
...
<PatternComparison
  alternatives={[
  {
    ...
    "when": "users need loading indicator instead of progress indicator as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
    "cons": [
      "Less specialized for progress indicator",
      "Different states and recovery paths to teach"
    ]
  },
  {
    "name": "Wizard / Stepper",
    "path": "/patterns/advanced/wizard",
    "when": "users need wizard / stepper instead of progress indicator as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
  ...
  {
    "name": "Skeleton",
    "path": "/patterns/user-feedback/skeleton",
    "when": "users need skeleton instead of progress indicator as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
...
<Playground patternType="user-feedback" pattern="progress-indicator" example="basic" presentation="hidden-code" />
...
<FaqStructuredData
  items={[
  {
    "question": "When should I choose Progress Indicator instead of Loading Indicator?",
    "answer": "Choose progress indicator when the job depends on show how far a task has advanced and how much work remains when the system can estimate that honestly. If the team only needs a lighter interaction with fewer states, Loading Indicator will usually be easier to ship and maintain."
  },
  {
    "question": "What is the biggest implementation risk with Progress Indicator?",
  ...
  {
    "question": "How do I know whether progress indicator is working well?",
