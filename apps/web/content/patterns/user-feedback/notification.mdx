...
<BuildEffort
  level="medium"
  description="Requires structured state, keyboard handling, and resilient feedback for inform users about important updates."
/>
...
<PatternComparison
  alternatives={[
  {
    ...
    "when": "users need loading indicator instead of notification as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
    "cons": [
      "Less specialized for notification",
  ...
  },
  {
    ...
    "when": "users need form validation instead of notification as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
  ...
  },
  {
    ...
    "when": "users need modal instead of notification as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
...
<Playground patternType="user-feedback" pattern="notification" example="basic" presentation="hidden-code" />
...
<FaqStructuredData
  items={[
  {
    "question": "When should I choose Notification instead of Loading Indicator?",
    "answer": "Choose notification when the job depends on deliver timely system feedback at the right level of urgency without derailing the user’s primary task. If the team only needs a lighter interaction with fewer states, Loading Indicator will usually be easier to ship and maintain."
  },
  {
    "question": "What is the biggest implementation risk with Notification?",
  ...
  {
    "question": "How do I know whether notification is working well?",
