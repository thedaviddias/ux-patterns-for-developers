...
<PatternComparison
  alternatives={[
  {
    ...
    "when": "users need loading indicator instead of skeleton as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
    "cons": [
      "Less specialized for skeleton",
      "Different states and recovery paths to teach"
    ]
  },
  {
    "name": "Empty States",
    "path": "/patterns/user-feedback/empty-states",
    "when": "users need empty states instead of skeleton as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
  ...
  },
  {
    ...
    "when": "users need card grid instead of skeleton as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
...
<Playground patternType="user-feedback" pattern="skeleton" example="basic" presentation="hidden-code" />
...
<FaqStructuredData
  items={[
  {
    "question": "When should I choose Skeleton instead of Loading Indicator?",
    "answer": "Choose skeleton when the job depends on preserve the shape of the final interface during loading so the page feels stable and easier to scan. If the team only needs a lighter interaction with fewer states, Loading Indicator will usually be easier to ship and maintain."
  },
  {
    "question": "What is the biggest implementation risk with Skeleton?",
  ...
  {
    "question": "How do I know whether skeleton is working well?",
