...
icon: Loader
status: complete
aliases: ["loader", "loading", "spinner"]
---
...
<BuildEffort
  level="low"
  description="Primarily markup, state classes, and accessible labeling for show users that content is being loaded."
/>
...
<PatternComparison
  alternatives={[
  {
    ...
    "when": "users need progress indicator instead of loading indicator as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
    "cons": [
      "Less specialized for loading indicator",
  ...
  },
  {
    ...
    "when": "users need skeleton instead of loading indicator as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
  ...
  },
  {
    ...
    "when": "users need notification instead of loading indicator as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
...
<Playground patternType="user-feedback" pattern="loading-indicator" example="basic" presentation="hidden-code" />
...
<FaqStructuredData
  items={[
  {
    "question": "When should I choose Loading Indicator instead of Progress Indicator?",
    "answer": "Choose loading indicator when the job depends on show that work is in progress without overstating certainty about duration or completion. If the team only needs a lighter interaction with fewer states, Progress Indicator will usually be easier to ship and maintain."
  },
  {
    "question": "What is the biggest implementation risk with Loading Indicator?",
  ...
  {
    "question": "How do I know whether loading indicator is working well?",
