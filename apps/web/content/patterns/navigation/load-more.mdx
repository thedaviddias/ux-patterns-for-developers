...
<BuildEffort
level="medium"
  description="Requires dynamic content loading, state management, accessibility considerations ([keyboard navigation](/glossary/keyboard-navigation), `aria-live` updates), and performance optimizations. The button should be removed when all content is loaded."
/>
<GuidesBanner
title="Load More vs [Pagination](/glossary/pagination) vs Infinite Scroll?"
...
<PatternComparison
  ...
  description="Load More is usually the balanced middle ground. Compare it with the two extremes before you decide whether your surface needs more control or more momentum."
  alternatives={[
    {
      name: "Pagination",
      path: "/patterns/navigation/pagination",
      when: "users need exact page jumps, stable URLs, or clearer orientation through large result sets",
      pros: ["Better SEO and sharing", "Clear position indicator", "Strong recovery"],
      cons: ["More navigation overhead", "Feels heavier for casual browsing"]
    },
    {
      name: "Infinite Scroll",
      path: "/patterns/navigation/infinite-scroll",
      when: "the experience is truly feed-like and uninterrupted consumption matters more than control",
      pros: ["No load trigger", "Strong engagement", "Great for passive browsing"],
      cons: ["Harder footer access", "Weaker recovery and bookmarking"]
    }
  ]}
/>
