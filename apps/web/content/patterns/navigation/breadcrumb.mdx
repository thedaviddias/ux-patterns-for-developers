...
<BuildEffort
level="medium"
  description="Requires structured navigation, [ARIA attributes](/glossary/aria-attributes) (`aria-label`, `aria-current`), and responsive handling for long paths."
/>
## Use Cases
...
<Playground patternType="navigation" pattern="breadcrumb" example="basic" presentation="hidden-code" />
  ...
  items={[
    {
      ...
      answer:
        "Breadcrumb navigation is a secondary navigation aid that helps users understand their location within a website's hierarchy. It provides a trail of links, often starting from the homepage or the first meaningful parent section, that shows the path to the current page.",
    },
    {
    ...
    },
    {
      ...
      answer:
        ...
        "1. Start with the homepage when it is part of the visible trail; otherwise start with the first meaningful parent section\n" +
