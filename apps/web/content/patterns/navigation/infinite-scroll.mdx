...
<GuidesBanner
  ...
  guidePath="/pattern-guide/pagination-vs-infinite-scroll"
/>
  ...
  alternatives={[
    {
      ...
      when: "users need precise navigation and bookmarkable pages",
      pros: ["Clear position", "SEO friendly", "Footer accessible"],
      cons: ["Requires user action", "Interrupts flow"]
    },
    {
      name: "Load More",
      path: "/patterns/navigation/load-more",
      when: "users want control over when to load content",
      pros: ["User control", "Footer accessible", "Better for mobile"],
      cons: ["Requires clicks", "Less engaging"]
    },
    {
      name: "Back to Top",
      path: "/patterns/navigation/back-to-top",
      when: "users need quick navigation to page start with long content",
      pros: ["Quick return", "Works with any pattern", "Simple to implement"],
      cons: ["Not a content loading solution", "Only helps with upward navigation"]
    }
  ]}
/>
