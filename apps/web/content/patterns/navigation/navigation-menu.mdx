...
<BuildEffort
  level="medium"
  description="Requires responsive layout handling, active state management, optional dropdown submenus, keyboard navigation, and ARIA landmark labeling. Sticky positioning and mobile collapse add further effort."
/>
...
<BrowserSupport features={["css.properties.position.sticky", "css.properties.display.flex", "html.elements.nav"]} />
