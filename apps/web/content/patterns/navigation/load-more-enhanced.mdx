...
Before diving into implementation details, let's see Load More in action:

<div className="grid gap-6 my-8">
  <div className="grid md:grid-cols-2 gap-6">
    <div>
      <h3 className="text-lg font-semibold mb-3 text-green-600">✅ Good Example</h3>
      <GalleryImage
        src="/gallery/load-more/shop-grid-good.webp"
        alt="E-commerce grid with clear Load More button and progress indicator"
        caption="Clear Load More button with progress indicator showing '24 of 120 products'"
        width={400}
        height={300}
      />
      <div className="mt-2 text-sm text-muted-foreground">
        ...
        <ul className="list-disc list-inside mt-1 space-y-1">
          <li>Clear progress indicator (24 of 120 products)</li>
          <li>Prominent, accessible button</li>
          <li>Consistent grid layout</li>
          <li>Footer remains reachable</li>
        </ul>
      </div>
    </div>
    
    <div>
      <h3 className="text-lg font-semibold mb-3 text-red-600">❌ Bad Example</h3>
      <GalleryImage
        src="/gallery/load-more/infinite-scroll-bad.webp"
        alt="Infinite scroll implementation that hides footer and lacks user control"
        caption="Infinite scroll that makes footer unreachable and overwhelms users"
        width={400}
        height={300}
      />
      <div className="mt-2 text-sm text-muted-foreground">
        ...
        <ul className="list-disc list-inside mt-1 space-y-1">
          <li>Footer becomes unreachable</li>
          <li>No user control over loading</li>
          <li>Can cause performance issues</li>
          <li>Difficult to bookmark position</li>
        </ul>
      </div>
    </div>
  </div>
...
<Playground patternType="navigation" pattern="load-more" example="basic" height="400px" />

*Try clicking the Load More button above to see the pattern in action*
...
<GalleryImage
  src="/gallery/load-more/amazon-products.webp"
  alt="Amazon product grid with Load More functionality"
  caption="Amazon uses Load More for product listings to maintain performance while allowing deep browsing"
  width={600}
  height={400}
/>
...
<GalleryImage
  src="/gallery/load-more/linkedin-feed.webp"
  alt="LinkedIn feed with Load More button"
  caption="LinkedIn's feed uses Load More to prevent infinite scroll fatigue while keeping users engaged"
  width={600}
  height={400}
/>
  ...
  alternatives={[
    {
      ...
      when: "users need to jump to specific pages or see total item count",
      pros: ["Better for SEO", "Clear position indicator"],
      cons: ["More clicks required", "Page reload disruption"]
    },
    {
      name: "Infinite Scroll",
      path: "/patterns/navigation/infinite-scroll",
      when: "content consumption should be seamless and continuous",
      pros: ["No user action needed", "Smooth browsing"],
      cons: ["Hard to reach footer", "Can't bookmark position"]
    }
  ]}
/>
...
<GalleryImage
  src="/gallery/load-more/preview-cards.webp"
  alt="Load More button with preview cards showing upcoming content"
  caption="Preview cards give users a glimpse of what they'll get when clicking Load More"
  width={600}
  height={300}
/>
...
<GalleryImage
  src="/gallery/load-more/with-counter.webp"
  alt="Load More button showing specific count of items to load"
  caption="'Load 10 More Items' is more engaging than generic 'Load More'"
  width={600}
  height={300}
/>
...
<GalleryImage
  src="/gallery/load-more/skeleton-loading.webp"
  alt="Load More with skeleton screens while loading"
  caption="Skeleton screens provide immediate feedback while content loads"
  width={600}
  height={300}
/>
