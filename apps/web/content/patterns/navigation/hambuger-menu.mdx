...
<BuildEffort
level="medium"
  description="Requires CSS animation for open/close transitions, JavaScript for toggle state, focus trapping inside the open panel, body scroll lock, and proper [ARIA attributes](/glossary/aria-attributes) (aria-expanded, aria-controls)."
/>
## Use Cases
