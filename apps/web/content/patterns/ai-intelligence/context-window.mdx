...
<BuildEffort
  level="high"
  description="Requires coordinated state, async data, and strong accessibility coverage across the full context window experience."
/>
...
<PatternComparison
  alternatives={[
  {
    ...
    "when": "users need token counter instead of context window as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
    "cons": [
      "Less specialized for context window",
  ...
  },
  {
    ...
    "when": "users need ai chat interface instead of context window as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
  ...
  },
  {
    ...
    "when": "users need streaming response instead of context window as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
...
<FaqStructuredData
  items={[
  {
    "question": "When should I choose Context Window instead of Token Counter?",
    "answer": "Choose context window when the job depends on show how much conversational or working memory remains and what the system will keep, compress, or drop. If the team only needs a lighter interaction with fewer states, Token Counter will usually be easier to ship and maintain."
  },
  {
    "question": "What is the biggest implementation risk with Context Window?",
  ...
  {
    "question": "How do I know whether context window is working well?",
