...
<BuildEffort
  level="high"
  description="Requires coordinated state, async data, and strong accessibility coverage across the full ai chat interface experience."
/>
...
<PatternComparison
  alternatives={[
  {
    ...
    "when": "users need prompt input instead of ai chat interface as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
    "cons": [
      "Less specialized for ai chat interface",
      "Different states and recovery paths to teach"
    ]
  },
  {
    "name": "Streaming Response",
    "path": "/patterns/ai-intelligence/streaming-response",
    "when": "users need streaming response instead of ai chat interface as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
  ...
  },
  {
    ...
    "when": "users need response feedback instead of ai chat interface as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
...
<FaqStructuredData
  items={[
  {
    "question": "When should I choose AI Chat Interface instead of Prompt Input?",
    "answer": "Choose ai chat interface when the job depends on combine prompt entry, streaming output, history, and follow-up actions inside a conversational workflow. If the team only needs a lighter interaction with fewer states, Prompt Input will usually be easier to ship and maintain."
  },
  {
    "question": "What is the biggest implementation risk with AI Chat Interface?",
  ...
  {
    "question": "How do I know whether ai chat interface is working well?",
