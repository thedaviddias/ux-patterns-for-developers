...
<BuildEffort
  level="medium"
  description="Requires structured state, keyboard handling, and resilient feedback for ai model selection interface."
/>
...
<PatternComparison
  alternatives={[
  {
    ...
    "when": "users need prompt input instead of model selector as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
    "cons": [
      "Less specialized for model selector",
      "Different states and recovery paths to teach"
    ]
  },
  {
    "name": "Token Counter",
    "path": "/patterns/ai-intelligence/token-counter",
    "when": "users need token counter instead of model selector as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
  ...
  },
  {
    ...
    "when": "users need response feedback instead of model selector as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
...
<Playground patternType="ai-intelligence" pattern="model-selector" example="basic" presentation="hidden-code" />
...
<FaqStructuredData
  items={[
  {
    "question": "When should I choose Model Selector instead of Prompt Input?",
    "answer": "Choose model selector when the job depends on help users pick the right model or capability tier without making them decode internal provider terminology. If the team only needs a lighter interaction with fewer states, Prompt Input will usually be easier to ship and maintain."
  },
  {
    "question": "What is the biggest implementation risk with Model Selector?",
  ...
  {
    "question": "How do I know whether model selector is working well?",
...
<RelatedPatternsCard
  patterns={[
    ...
    },
    {
      title: "Token Counter",
      path: "/patterns/ai-intelligence/token-counter",
      description: "Display token usage and limits",
    },
    {
