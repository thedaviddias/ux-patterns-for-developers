...
<BuildEffort
  level="medium"
  description="Requires structured state, keyboard handling, and resilient feedback for feedback mechanisms for ai responses."
/>
...
<PatternComparison
  ...
  {
    "name": "Like Button",
    "path": "/patterns/social/like-button",
    "when": "users need like button instead of response feedback as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
    "cons": [
      "Less specialized for response feedback",
  ...
  },
  {
    ...
    "when": "users need notification instead of response feedback as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
  ...
  },
  {
    ...
    "path": "/patterns/ai-intelligence/ai-error-states",
    "when": "users need ai error states instead of response feedback as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
...
<Playground patternType="ai-intelligence" pattern="response-feedback" example="basic" presentation="hidden-code" />
...
<FaqStructuredData
  items={[
  {
    "question": "When should I choose Response Feedback instead of Like Button?",
    "answer": "Choose response feedback when the job depends on collect structured feedback on AI output quality while preserving the context needed to improve later responses. If the team only needs a lighter interaction with fewer states, Like Button will usually be easier to ship and maintain."
  },
  {
    "question": "What is the biggest implementation risk with Response Feedback?",
  ...
  {
    "question": "How do I know whether response feedback is working well?",
...
<RelatedPatternsCard
  patterns={[
    ...
    },
    {
      ...
      path: "/patterns/ai-intelligence/ai-error-states",
      description: "Handling AI-specific errors",
    },
  ]}
/>
