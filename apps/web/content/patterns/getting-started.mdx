...
<Callout type="info">
  ...
  Subscribe to our updates by starring the repository on GitHub or by subscribing to our newsletter
...
12. **Testing** - Guidelines for unit, integration, and accessibility testing
13. **[Design Tokens](/glossary/design-tokens)** - Design system variables and customization options
14. **Related Patterns** - Links to similar or complementary patterns
15. **FAQs** - Common questions and detailed answers
16. **Resources** - Additional documentation, articles, libraries...
## Getting Started
