...
1. **Text Only**
   ...
   <ComponentPreviewServer name="button-default" />
...
<Playground patternType="forms" pattern="button" example="basic" presentation="hidden-code" />
...
items={[
    ...
    },
    {
      ...
      answer:
        "Ensure buttons are focusable, provide descriptive labels, support keyboard interactions, and have sufficient color contrast. Use [semantic HTML](/glossary/semantic-html) elements like `<button>` and manage ARIA attributes appropriately.",
    },
    {
