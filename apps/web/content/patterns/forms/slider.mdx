...
<BuildEffort
  level="medium"
  description="Requires structured state, keyboard handling, and resilient feedback for select values from a range."
/>
...
<PatternComparison
  alternatives={[
  {
    ...
    "when": "users need selection input instead of slider as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
    "cons": [
      "Less specialized for slider",
  ...
  },
  {
    ...
    "when": "users need rating input instead of slider as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
  ...
  },
  {
    ...
    "when": "users need toggle instead of slider as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
...
<Playground patternType="forms" pattern="slider" example="basic" presentation="hidden-code" />
...
<FaqStructuredData
  items={[
  {
    "question": "When should I choose Slider instead of Selection Input?",
    "answer": "Choose slider when the job depends on let users choose a value from a bounded range while keeping the current position and step size easy to understand. If the team only needs a lighter interaction with fewer states, Selection Input will usually be easier to ship and maintain."
  },
  {
    "question": "What is the biggest implementation risk with Slider?",
  ...
  {
    "question": "How do I know whether slider is working well?",
