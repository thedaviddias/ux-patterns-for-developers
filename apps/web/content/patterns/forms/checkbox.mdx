...
icon: SquareCheck
status: complete
aliases: ["tick box", "selection box"]
popularity: high
---
...
<BuildEffort
level="low"
  description="Native HTML input with optional styling enhancements. Requires proper labeling, [keyboard navigation](/glossary/keyboard-navigation), and [ARIA attributes](/glossary/aria-attributes) for accessibility."
/><GuidesBanner
