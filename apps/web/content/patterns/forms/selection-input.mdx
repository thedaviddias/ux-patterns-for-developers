...
<GuidesBanner
  title="Dropdown vs Radio vs Checkbox?"
...
<Playground patternType="forms" pattern="selection-input" example="basic" presentation="hidden-code" />
...
- [ ] Verify keyboard navigation (`Tab`, arrows, `Enter`, `Escape`) works predictably.
