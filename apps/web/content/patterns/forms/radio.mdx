...
<BuildEffort
level="low"
  description="Native HTML radio inputs with optional styling enhancements. Requires proper fieldset/legend structure, [keyboard navigation](/glossary/keyboard-navigation) with arrow keys, and [ARIA attributes](/glossary/aria-attributes) for accessibility."
/>
