...
<BuildEffort
  level="medium"
  description="Requires structured state, keyboard handling, and resilient feedback for allow users to sign their name."
/>
...
<PatternComparison
  alternatives={[
  {
    ...
    "when": "users need file input instead of signature pad as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
    "cons": [
      "Less specialized for signature pad",
  ...
  },
  {
    ...
    "when": "users need button instead of signature pad as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
  ...
  },
  {
    ...
    "when": "users need form validation instead of signature pad as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
...
<Playground patternType="forms" pattern="signature-pad" example="basic" presentation="hidden-code" />
...
<FaqStructuredData
  items={[
  {
    "question": "When should I choose Signature Pad instead of File Input?",
    "answer": "Choose signature pad when the job depends on capture a handwritten mark or consent signature in a way that feels legitimate, recoverable, and device-aware. If the team only needs a lighter interaction with fewer states, File Input will usually be easier to ship and maintain."
  },
  {
    "question": "What is the biggest implementation risk with Signature Pad?",
  ...
  {
    "question": "How do I know whether signature pad is working well?",
