...
<BuildEffort
  level="medium"
  description="Requires structured state, keyboard handling, and resilient feedback for validate and provide feedback."
/>
...
<PatternComparison
  alternatives={[
  {
    ...
    "when": "users need text field instead of form validation as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
    "cons": [
      "Less specialized for form validation",
  ...
  },
  {
    ...
    "when": "users need date input instead of form validation as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
  ...
  },
  {
    ...
    "when": "users need button instead of form validation as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
...
<Playground patternType="forms" pattern="form-validation" example="basic" presentation="hidden-code" />
...
<FaqStructuredData
  items={[
  {
    "question": "When should I choose Form Validation instead of Text Field?",
    "answer": "Choose form validation when the job depends on provide field-level and form-level feedback without interrupting users before they have enough information to succeed. If the team only needs a lighter interaction with fewer states, Text Field will usually be easier to ship and maintain."
  },
  {
    "question": "What is the biggest implementation risk with Form Validation?",
  ...
  {
    "question": "How do I know whether form validation is working well?",
