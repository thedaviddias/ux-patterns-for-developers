...
<BuildEffort
  level="low"
  description="Primarily markup, state classes, and accessible labeling for rate something with a number of stars."
/>
...
<PatternComparison
  alternatives={[
  {
    ...
    "when": "users need radio instead of rating input as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
    "cons": [
      "Less specialized for rating input",
  ...
  },
  {
    ...
    "when": "users need like button instead of rating input as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
  ...
  {
    "name": "Slider",
    "path": "/patterns/forms/slider",
    "when": "users need slider instead of rating input as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
...
<Playground patternType="forms" pattern="rating-input" example="basic" presentation="hidden-code" />
...
<FaqStructuredData
  items={[
  {
    "question": "When should I choose Rating Input instead of Radio?",
    "answer": "Choose rating input when the job depends on let users express a graded opinion quickly while still exposing the value clearly to assistive technology. If the team only needs a lighter interaction with fewer states, Radio will usually be easier to ship and maintain."
  },
  {
    "question": "What is the biggest implementation risk with Rating Input?",
  ...
  {
    "question": "How do I know whether rating input is working well?",
