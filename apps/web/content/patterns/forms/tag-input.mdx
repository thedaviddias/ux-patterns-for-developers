...
<BuildEffort
  level="medium"
  description="Requires structured state, keyboard handling, and resilient feedback for enter and format tags."
/>
...
<PatternComparison
  alternatives={[
  {
    ...
    "when": "users need multi-select input instead of tag input as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
    "cons": [
      "Less specialized for tag input",
  ...
  },
  {
    ...
    "when": "users need autocomplete instead of tag input as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
  ...
  },
  {
    ...
    "when": "users need text field instead of tag input as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
...
<Playground patternType="forms" pattern="tag-input" example="basic" presentation="hidden-code" />
...
<FaqStructuredData
  items={[
  {
    "question": "When should I choose Tag Input instead of Multi-Select Input?",
    "answer": "Choose tag input when the job depends on let users enter, review, and remove several short values without losing readability or keyboard efficiency. If the team only needs a lighter interaction with fewer states, Multi-Select Input will usually be easier to ship and maintain."
  },
  {
    "question": "What is the biggest implementation risk with Tag Input?",
  ...
  {
    "question": "How do I know whether tag input is working well?",
