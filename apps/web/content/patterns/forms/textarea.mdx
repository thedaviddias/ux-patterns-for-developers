...
<BuildEffort
  level="low"
  description="Primarily markup, state classes, and accessible labeling for multi-line text input for longer content."
/>
...
<PatternComparison
  alternatives={[
  {
    ...
    "when": "users need text field instead of textarea as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
    "cons": [
      "Less specialized for textarea",
      "Different states and recovery paths to teach"
    ]
  },
  {
    "name": "Rich Text Editor",
    "path": "/patterns/forms/rich-text-editor",
    "when": "users need rich text editor instead of textarea as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
  ...
  },
  {
    ...
    "when": "users need form validation instead of textarea as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
...
<Playground patternType="forms" pattern="textarea" example="basic" presentation="hidden-code" />
...
<FaqStructuredData
  items={[
  {
    "question": "When should I choose Textarea instead of Text Field?",
    "answer": "Choose textarea when the job depends on collect longer freeform text while keeping length, guidance, and validation manageable. If the team only needs a lighter interaction with fewer states, Text Field will usually be easier to ship and maintain."
  },
  {
    "question": "What is the biggest implementation risk with Textarea?",
  ...
  {
    "question": "How do I know whether textarea is working well?",
