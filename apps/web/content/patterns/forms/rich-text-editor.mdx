...
<BuildEffort
  level="high"
  description="Requires coordinated state, async data, and strong accessibility coverage across the full rich text editor experience."
/>
...
<PatternComparison
  alternatives={[
  {
    ...
    "when": "users need textarea instead of rich text editor as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
    "cons": [
      "Less specialized for rich text editor",
  ...
  },
  {
    ...
    "when": "users need button instead of rich text editor as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
  ...
  {
    "name": "Tag Input",
    "path": "/patterns/forms/tag-input",
    "when": "users need tag input instead of rich text editor as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
...
<Playground patternType="forms" pattern="rich-text-editor" example="basic" presentation="hidden-code" />
...
<FaqStructuredData
  items={[
  {
    "question": "When should I choose Rich Text Editor instead of Textarea?",
    "answer": "Choose rich text editor when the job depends on let users create formatted text while keeping the editing surface understandable, accessible, and safe to submit. If the team only needs a lighter interaction with fewer states, Textarea will usually be easier to ship and maintain."
  },
  {
    "question": "What is the biggest implementation risk with Rich Text Editor?",
  ...
  {
    "question": "How do I know whether rich text editor is working well?",
