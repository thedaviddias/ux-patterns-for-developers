...
items={[
    ...
    },
    {
      ...
      answer:
        "Ensure the password field is focusable, provide clear labels, support [keyboard navigation](/glossary/keyboard-navigation), and offer options to unmask the password for verification purposes.",
    },
    {
      question:
