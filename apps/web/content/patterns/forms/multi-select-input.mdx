...
<BuildEffort
level="medium"
  description="Tag-based multi-select requires dropdown management, chip rendering, [keyboard navigation](/glossary/keyboard-navigation) (Space to select, Backspace to remove last tag), search/filter within options, and select-all behavior."
/>
## Use Cases
