...
icon: RotateCw
status: complete
aliases: ["slider", "slideshow", "image rotator"]
popularity: medium
---
...
<BuildEffort
level="high"
  description="Requires touch/swipe support, [keyboard navigation](/glossary/keyboard-navigation), [lazy loading](/glossary/lazy-loading), auto-play controls, and proper focus management to ensure accessibility."
/>
  ...
  alternatives={[
    {
      ...
      when: "content sections are distinct and users need direct access",
      pros: ["Direct navigation", "All options visible", "No auto-rotation"],
      cons: ["Takes more space", "Not for many items", "Less visual impact"]
    },
    {
      name: "Accordion",
      path: "/patterns/content-management/accordion",
      when: "vertical space is limited and content is text-heavy",
      pros: ["Vertical layout", "Progressive disclosure", "Better for text"],
      cons: ["Not for images", "Less engaging", "No auto-play"]
    },
    {
      name: "Card Grid",
      path: "/patterns/data-display/card-grid",
      when: "all items need equal visibility and comparison",
      pros: ["All visible", "Easy comparison", "No interaction needed"],
      cons: ["Takes more space", "Requires scrolling", "Less focus"]
    }
  ]}
/>
