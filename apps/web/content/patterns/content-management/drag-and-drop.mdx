...
<BuildEffort
  level="high"
  description="Requires coordinated state, async data, and strong accessibility coverage across the full drag and drop experience."
/>
...
<PatternComparison
  ...
  {
    "name": "Kanban Board",
    "path": "/patterns/data-display/kanban-board",
    "when": "users need kanban board instead of drag and drop as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
    "cons": [
      "Less specialized for drag and drop",
  ...
  },
  {
    ...
    "when": "users need list view instead of drag and drop as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
  ...
  {
    "name": "Image Upload",
    "path": "/patterns/media/image-upload",
    "when": "users need image upload instead of drag and drop as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
...
<Playground patternType="content-management" pattern="drag-and-drop" example="basic" presentation="hidden-code" />
...
<FaqStructuredData
  items={[
  {
    "question": "When should I choose Drag and Drop instead of Kanban Board?",
    "answer": "Choose drag and drop when the job depends on let users move or reorder items spatially while preserving clear feedback, keyboard alternatives, and safe recovery. If the team only needs a lighter interaction with fewer states, Kanban Board will usually be easier to ship and maintain."
  },
  {
    "question": "What is the biggest implementation risk with Drag and Drop?",
  ...
  {
    "question": "How do I know whether drag and drop is working well?",
  ...
  patterns={[
    {
      title: "Kanban Board",
      path: "/patterns/data-display/kanban-board",
      description: "Organize tasks in columns and swimlanes",
    },
    {
      title: "List View",
      path: "/patterns/data-display/list-view",
