...
icon: Plus
status: complete
aliases: ["collapsible text", "Read More/Read Less"]
---
...
items={[
    ...
    },
    {
      ...
      answer:
        "Ensure that the trigger for expanding text is a focusable element, like a button, and manage ARIA attributes such as 'aria-expanded' to indicate the state. Support [keyboard navigation](/glossary/keyboard-navigation) and provide clear visual indicators for focus and state changes.",
    },
    {
