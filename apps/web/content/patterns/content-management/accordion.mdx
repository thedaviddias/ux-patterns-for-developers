...
<BuildEffort
level="medium"
  description="Requires expand/collapse logic, proper [ARIA attributes](/glossary/aria-attributes) (`aria-expanded`), and smooth content visibility toggling."
/>
## Use Cases
...
<PatternComparison
  ...
  alternatives={[
    ...
    },
    {
      ...
      path: "/patterns/content-management/expandable-text",
...
<Playground patternType="content-management" pattern="accordion" example="basic" presentation="hidden-code" />
