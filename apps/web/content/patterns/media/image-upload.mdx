...
<BuildEffort
  level="medium"
  description="Requires structured state, keyboard handling, and resilient feedback for upload and preview images."
/>
...
<PatternComparison
  ...
  {
    "name": "File Input",
    "path": "/patterns/forms/file-input",
    "when": "users need file input instead of image upload as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
    "cons": [
      "Less specialized for image upload",
  ...
  },
  {
    ...
    "when": "users need drag and drop instead of image upload as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
  ...
  },
  {
    ...
    "when": "users need progress indicator instead of image upload as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
...
<Playground patternType="media" pattern="image-upload" example="basic" presentation="hidden-code" />
...
<FaqStructuredData
  items={[
  {
    "question": "When should I choose Image Upload instead of File Input?",
    "answer": "Choose image upload when the job depends on let users select, preview, validate, and replace an image confidently before or during upload. If the team only needs a lighter interaction with fewer states, File Input will usually be easier to ship and maintain."
  },
  {
    "question": "What is the biggest implementation risk with Image Upload?",
  ...
  {
    "question": "How do I know whether image upload is working well?",
