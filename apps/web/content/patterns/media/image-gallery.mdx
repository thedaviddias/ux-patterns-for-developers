...
<BuildEffort
  level="medium"
  description="Requires structured state, keyboard handling, and resilient feedback for display and browse image collections."
/>
...
<PatternComparison
  ...
  {
    "name": "Carousel",
    "path": "/patterns/content-management/carousel",
    "when": "users need carousel instead of image gallery as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
    "cons": [
      "Less specialized for image gallery",
  ...
  },
  {
    ...
    "when": "users need modal instead of image gallery as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
  ...
  },
  {
    ...
    "when": "users need image upload instead of image gallery as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
...
<Playground patternType="media" pattern="image-gallery" example="basic" presentation="hidden-code" />
...
<FaqStructuredData
  items={[
  {
    "question": "When should I choose Image Gallery instead of Carousel?",
    "answer": "Choose image gallery when the job depends on help users browse several related images without losing orientation, context, or performance. If the team only needs a lighter interaction with fewer states, Carousel will usually be easier to ship and maintain."
  },
  {
    "question": "What is the biggest implementation risk with Image Gallery?",
  ...
  {
    "question": "How do I know whether image gallery is working well?",
