...
<BuildEffort
  level="high"
  description="Requires coordinated state, async data, and strong accessibility coverage across the full activity feed experience."
/>
...
<PatternComparison
  ...
  {
    "name": "Comment System",
    "path": "/patterns/social/comment-system",
    "when": "users need comment system instead of activity feed as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
    "cons": [
      "Less specialized for activity feed",
  ...
  },
  {
    ...
    "when": "users need notification instead of activity feed as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
  ...
  },
  {
    ...
    "when": "users need infinite scroll instead of activity feed as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
...
<Playground patternType="social" pattern="activity-feed" example="basic" presentation="hidden-code" />
...
<FaqStructuredData
  items={[
  {
    "question": "When should I choose Activity Feed instead of Comment System?",
    "answer": "Choose activity feed when the job depends on surface recent actions in a chronological stream so users can monitor what changed without visiting each item separately. If the team only needs a lighter interaction with fewer states, Comment System will usually be easier to ship and maintain."
  },
  {
    "question": "What is the biggest implementation risk with Activity Feed?",
  ...
  {
    "question": "How do I know whether activity feed is working well?",
  ...
  patterns={[
    {
      ...
      path: "/patterns/social/comment-system",
      description: "User comments and discussion threads",
    },
    {
      title: "Notification",
      path: "/patterns/user-feedback/notification",
