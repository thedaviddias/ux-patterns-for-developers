...
<PatternComparison
  alternatives={[
  {
    ...
    "when": "users need search field instead of command palette as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
    "cons": [
      "Less specialized for command palette",
  ...
  },
  {
    ...
    "when": "users need modal instead of command palette as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
  ...
  },
  {
    ...
    "when": "users need navigation menu instead of command palette as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
