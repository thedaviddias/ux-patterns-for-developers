...
<BuildEffort
  level="medium"
  description="Requires structured state, keyboard handling, and resilient feedback for multi-step forms and processes."
/>
...
<PatternComparison
  alternatives={[
  {
    ...
    "when": "users need progress indicator instead of wizard / stepper as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
    "cons": [
      "Less specialized for wizard / stepper",
  ...
  },
  {
    ...
    "when": "users need form validation instead of wizard / stepper as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
  ...
  },
  {
    ...
    "when": "users need checkout flow instead of wizard / stepper as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
...
<Playground patternType="advanced" pattern="wizard" example="basic" presentation="hidden-code" />
...
<FaqStructuredData
  items={[
  {
    "question": "When should I choose Wizard / Stepper instead of Progress Indicator?",
    "answer": "Choose wizard / stepper when the job depends on break a long process into ordered steps with visible progress and review checkpoints. If the team only needs a lighter interaction with fewer states, Progress Indicator will usually be easier to ship and maintain."
  },
  {
    "question": "What is the biggest implementation risk with Wizard / Stepper?",
  ...
  {
    "question": "How do I know whether wizard / stepper is working well?",
