...
<BuildEffort
  level="high"
  description="Requires coordinated state, async data, and strong accessibility coverage across the full search results experience."
/>
...
alternatives={[
  {
    ...
    "when": "users need search field instead of search results as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
    "cons": [
      "Less specialized for search results",
  ...
  },
  {
    ...
    "when": "users need filter panel instead of search results as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
  ...
  },
  {
    ...
    "when": "users need pagination instead of search results as the primary interaction",
    "pros": [
      "Clearer fit for its own job",
      "Lower ambiguity about the expected interaction"
    ],
...
<Playground patternType="advanced" pattern="search-results" example="basic" presentation="hidden-code" />
...
<FaqStructuredData
  items={[
  {
    "question": "When should I choose Search Results instead of Search Field?",
    "answer": "Choose search results when the job depends on turn a query into a ranked, filterable list that helps users recover from broad or imperfect searches. If the team only needs a lighter interaction with fewer states, Search Field will usually be easier to ship and maintain."
  },
  {
    "question": "What is the biggest implementation risk with Search Results?",
  ...
  {
    "question": "How do I know whether search results is working well?",
