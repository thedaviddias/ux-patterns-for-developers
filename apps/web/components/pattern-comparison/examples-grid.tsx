...
import { AspectRatio } from "@ux-patterns/ui/components/shadcn/aspect-ratio";
import {
	Dialog,
	DialogContent,
	DialogDescription,
...
import { ImagePlaceholder } from "@ux-patterns/ui/components/shadcn/image-placeholder";
				...
				{examples.map((pattern) => (
					...
					>
						<div className="flex items-start gap-3">
							<div>
								<h3 className="text-lg font-medium mt-0">{pattern.pattern}</h3>
							</div>
						</div>
