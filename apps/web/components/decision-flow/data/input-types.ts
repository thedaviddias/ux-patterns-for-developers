...
export const nodes: DecisionNode[] = [
	...
	},
	{
		...
		data: {
			...
			description:
				"Does the input require special formatting or complex interaction?",
		},
...
export const edges: DecisionEdge[] = [
	...
	{
		id: "option_count-radio",
		source: "option_count",
		target: "radio",
		label: "< 5",
	},
	{
		id: "option_count-select",
		source: "option_count",
		target: "select",
		label: "> 5",
	},
