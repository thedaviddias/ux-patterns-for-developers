...
export function Sidebar({
	...
	return (
		<>
			...
			<aside
				className={cn(
					"fixed top-16 left-4 z-40 h-[calc(100vh-5rem)] w-[min(20rem,calc(100vw-2rem))] overflow-hidden rounded-[2rem] border border-border/70 bg-card/95 shadow-[0_28px_90px_-55px_rgba(15,23,42,0.65)] backdrop-blur transition-transform duration-300 ease-in-out lg:hidden",
...
export function SidebarTrigger({ className }: { className?: string }) {
	...
	return (
		<button
			type="button"
			className={cn(
				"rounded-xl border border-border/70 bg-background/80 p-2 hover:bg-accent lg:hidden",
				className,
			)}
