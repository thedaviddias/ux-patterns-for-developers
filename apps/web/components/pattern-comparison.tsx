		...
		<div className={cn("mt-6", className)}>
			...
			<div className="space-y-3">
				{alternatives.map((alt) => (
					<div
						className="block border border-neutral-200 dark:border-neutral-800 bg-card rounded-lg p-4 transition-all duration-200 hover:border-neutral-300 dark:hover:border-neutral-700 relative"
						key={alt.name}
					>
						<div className="mb-2">
