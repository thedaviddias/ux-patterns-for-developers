	...
	"inline-flex items-center gap-2 cursor-pointer transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 relative",
	{
		variants: {
			variant: {
				...
				primary:
					"text-primary hover:text-primary/80 hover:translate-x-0.5 underline",
				destructive:
					"text-destructive hover:text-destructive/80 hover:scale-105",
				muted: "text-muted-foreground hover:text-muted-foreground/80",
				neutral:
					"flex items-center gap-2 dark:text-neutral-800 border border-neutral-400 bg-neutral-100 rounded-md px-4 py-2 !no-underline",
				outline:
					"border border-current rounded-md px-3 py-1.5 hover:bg-accent/10 dark:hover:bg-neutral-100 dark:hover:text-neutral-900",
