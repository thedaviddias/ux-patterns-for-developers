...
- Auto-scroll to top of content area when loading new pages
- Move focus to main content or first item after loading
- Announce loading status with ARIA live regions for screen readers
...
**Dozens of pages** overwhelm users and make finding relevant content hard.

**How to Fix It?**
Try **"Load More"** or **infinite scroll** for continuous exploration content. When pagination is necessary, cap total pages or add filters to reduce results.
...
Removing pagination on small screens forces mobile users into endless scrolling or guessing navigation to deeper pages.

**How to Fix It?**
Add a **compact pagination menu** (next/previous buttons or limited page links) so mobile users still control navigation.
...
**How to Fix It:**
Keep scroll position or smoothly animate to top with clear indication.
...
- Avoid duplicate content issues with proper canonical tags
...
Consider these related patterns when implementing **Pagination**:

- [Load More](/patterns/navigation/load-more) - Alternative for continuous content loading
- [Infinite Scroll](/patterns/navigation/infinite-scroll) - Automatic content loading on scroll
- [Table](/patterns/data-display/table) - Often uses pagination for large datasets
- [Search Results](/patterns/search/search-results) - Commonly paired with pagination
...
- [SEO Best Practices for Pagination](https://developers.google.com/search/docs/specialty/ecommerce/pagination)
- [Accessibility Guidelines for Pagination](https://www.w3.org/WAI/ARIA/apg/patterns/pagination/)
