...
Try out this live implementation of the Load More pattern:
...
- [React Infinite Scroll Component](https://github.com/ankeetmaini/react-infinite-scroll-component) - Includes load more functionality
