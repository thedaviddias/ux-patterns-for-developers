...
### Position Adjustment
- **Effect:** Smooth repositioning when viewport edge detected
- **Timing:** 150ms ease-in-out
- **Trigger:** When tooltip would overflow viewport
...
- **Viewport Detection**: Prevent tooltips from triggering reflows
...
- [Tooltip - Origin UI](https://originui.com/tooltip) – Vanilla JS tooltip implementation
