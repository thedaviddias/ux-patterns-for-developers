...
import {
  edges,
  nodes,
} from "@app/_components/decision-flow/data/navigation-patterns";
...
import { PerformanceMetrics } from "@app/_components/pattern-comparison/performance-metrics";
...
<div>
  ...
  <PerformanceMetrics patterns={performanceData.patterns} />
